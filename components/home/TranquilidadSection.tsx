...
export default function TranquilidadSection({ title, description, image }: Props) {
  ...
  return (
    <section style={{ background: "rgb(34, 48, 15)", padding: "0" }}>
      <div
        style={{
          maxWidth: "1180px",
          margin: "0 auto",
      ...
      >
        ...
        <div style={{
          ...
          <span style={{
            ...
            textTransform: "uppercase", color: "rgb(162, 210, 100)",
          }}>
            Nuestro compromiso
          </span>
          <h2 style={{
        ...
        <div style={{ position: "relative", overflow: "hidden" }}>
          ...
          />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgb(34,48,15) 0%, transparent 30%)" }} />
        </div>
      </div>
